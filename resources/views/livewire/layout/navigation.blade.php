...
.active {
 ...
 background:#f7fafc;
    ...
    <!-- Sidebar -->
      <div class="w-65 text-white p-2 bg-grey absolute top-16 hide-on-small" style="top: 65px; background: white; height: 93%; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.1); position: fixed; z-index: 1;">
        <!-- Sidebar Content -->
